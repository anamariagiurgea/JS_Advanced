// defining interface for class  toate metodele si prop sunt publice. o clasa poate sa implententeze
//  mai multe interfete
//o interfata poate mosteni mai multe interfete, clasa doar o clasa. ambele fol extend
//o cclasa poate implemen ta mai multe interfete
interface Person1 {  
    firstName: string;  
    lastName: string;  
